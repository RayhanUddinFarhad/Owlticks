            ...
            <div className="">
                ...
                >
                   <div className='space-x-5 my-5'>
                    ...
                    <input type="text" className='border p-1 rounded-lg' placeholder='you@example.com' />
                    <input type="text" className='border p-1 rounded-lg' placeholder='Enter your name' />
                   </div>

                   <textarea className='w-full p-1 rounded-lg' placeholder = 'type your message...'>


                   </textarea>

                   <button className='bg-black text-white p-2'>Contact us</button>
                </form>
            </div>
        </div>
