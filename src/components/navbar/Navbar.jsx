...
const Navbar = () => {
    ...
    const navigation = [
        ...
        { title: "Features", path: "javascript:void(0)", isDrapdown: false },
        { title: "Pricing", path: "javascript:void(0)", isDrapdown: false },
        { title: "Blog", path: "javascript:void(0)", isDrapdown: true, navs: dropdownNavs },
    ...
    return (
        <>
        <nav className={`relative z-20 bg-white w-full md:static md:text-sm border-b ${state ? "shadow-lg rounded-b-xl md:shadow-none" : ""}`}>
                ...
                <div className={`nav-menu flex-1 pb-3 mt-8 md:block md:pb-0 md:mt-0 ${state ? 'block' : 'hidden'}`}>
                    <ul className="items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                        ...
                        <div className='flex-1 items-center justify-end gap-x-6 space-y-3 md:flex md:space-y-0'>
                            <li>
                                <a href="javascript:void(0)" className="button-secondary">
                                    Register
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" className="button-primary">
Log in                                </a>
                            </li>
                        </div>
                    </ul>
